# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-06-26 06:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('d', 'Draft'), ('p', 'Published'), ('s', 'secrecy')], max_length=1, verbose_name='文章状态')),
                ('abstract', models.CharField(blank=True, help_text='可选，若为空则将摘取正文的前54个字符', max_length=54, null=True, verbose_name='摘要')),
